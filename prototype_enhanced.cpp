...
#include <chrono>    // For better random seeding
...
std::string generateChess960Position()
{
  ...
  // Use high-resolution time as the seed for randomness
...
{
  int numPositions;
  std::cout << "Enter the number of Chess960 positions to generate: ";
